...
<br>
    ...
    <input type="text" id="engineer" name="engineer" placeholder="Enter name of Engineer" required>
<br>
<br>
    <label for="status">status</label>
    <input type="text" id="status" name="status" placeholder="Enter a status" required>
<br>
